        ...
        <form onSubmit={handleSave} className="settings-form">
          ...
          <div className="settings-section card">
            ...
            <div className="settings-note">
              Save a personal access token with <code>repo</code> scope so RepoMind can work on your repositories.
              {GITHUB_OAUTH_ENABLED
                ? " Or connect GitHub to sign in and store the token returned by OAuth."
                : ""}
            </div>
            {GITHUB_OAUTH_ENABLED && (
              <button
